...
# Make it lowercase
sentence <- tolower("There is a cat who lives in Norway and loves to eat tomatoes.")
...
CountOccurances <- function(letter, letters) {
  return (length(letters[letter == letters]))
}
...
result <- sapply(letters.unique, CountOccurances, letters)
